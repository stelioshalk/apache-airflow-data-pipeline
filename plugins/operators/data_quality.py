...
class DataQualityOperator(BaseOperator):
    """
    The operator does a basic data quality check by counting the number of rows in each table.
    if the number od rows is zero, then the quality check is considered to be failed
    """
    ui_color = '#89DA59'
